    ...
    <div className="relative flex h-full w-full flex-col items-center justify-center">
      <div className="mx-auto max-w-lg space-y-5">
        <h2 className="mt-36 text-4xl font-medium tracking-tight">
          Animated Theme Toggle <br />
          Click to toggle the theme
        </h2>
        <p>
          Experience smooth theme transitions with various animation effects.
          Choose from different variants and starting positions.
        </p>
      </div>
...
const Options = ({
  ...
  return (
    <motion.div
      drag
      className="top-30 border-foreground/10 bg-muted/50 absolute right-1/2 flex w-[245px] translate-x-1/2 flex-col gap-3 rounded-3xl border p-3 backdrop-blur-sm lg:right-4 lg:translate-x-0"
    >
